...
description: SCSS/Sassy CSS best practices and coding guidelines for maintainable, scalable stylesheets, use it whenever you need to write or review SCSS code.
---
