---
name: css
description: Best practices for CSS development including modern layout techniques, naming conventions, theming, and maintainable stylesheet architecture, use it whenever you need to write or review CSS code.
---
